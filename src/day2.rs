...
pub fn solve() {
    ...
    time_it!("Time", let soln = problem1("files/2.txt"));
    println!("Solution for Day 2 problem 1 is {}", soln);
    time_it!("Time", let soln = problem2("files/2.txt"));
    println!("Solution for Day 2 problem 2 is {}", soln);
}
